...
router.get("/verify/:verificationToken", controllers_1.AuthController.verify);
router.post("/verify", (0, middlewares_1.validateBody)(User_1.schemas.verifyAgainEmailBodySchema), controllers_1.AuthController.verifyAgain);
