...
router.put("/:bookId", (0, middlewares_1.validateBody)(books_1.addSchema), controllers_1.BooksController.editBookById);
// --------- DELETE book to the list ---------
router.delete("/:bookId", controllers_1.BooksController.deleteBookById);
// --------- ADD book to the list ---------
router.post("/", (0, middlewares_1.validateBody)(books_1.addSchema), controllers_1.BooksController.addBook);
