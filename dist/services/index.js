...
const updateFavorite = (bookId, bookData) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield models_1.Book.findByIdAndUpdate(bookId, bookData, { new: true });
    return result;
});
